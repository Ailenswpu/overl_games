...
class Admin::UsersControllerTest < ActionController::TestCase
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post :create, admin_user: { created_at: @admin_user.created_at, provider: @admin_user.provider, uid: @admin_user.uid }
    end
  ...
  test "should update admin_user" do
    patch :update, id: @admin_user, admin_user: { created_at: @admin_user.created_at, provider: @admin_user.provider, uid: @admin_user.uid }
    assert_redirected_to admin_user_path(assigns(:admin_user))
  end
